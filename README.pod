...
Raisable - Turn classes into resolvable conditions
...
Please report any bugs or feature requests to bug-raisable@rt.cpan.org or through the web interface at:
 http://rt.cpan.org/Public/Dist/Display.html?Name=Raisable
